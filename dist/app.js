(function () {
  ...
  ***************************************************************************** */
  ...
  const resolveColours = (states, content, styles, colours) => {
      {
          let index = 1;
          // ** Font colour
  ...
  const resovleLoadContent = (lines, colours) => {
      const output = [];
      const states = {
          isBold: false,
          isItalic: false,
  ...
  class SearchComponent extends MintScope {
      constructor() {
          ...
          this.goToNext = function () {
              if (this.currentSearchIndex === this.lineIndexMatches.length - 1)
                  return;
